...
import { useAuth, isAdmin, isElevated, NEEDS_CONFIG } from './auth';
    ...
    return (
      <div className="app-wash grid h-screen place-items-center p-6">
        <div className="max-w-md rounded-lg border border-border bg-card p-8 text-center">
          ...
          <p className="mt-2 text-[.88rem] text-muted-foreground">Set <code className="font-mono">VITE_GOOGLE_CLIENT_ID</code> in <code className="font-mono">dashboard-app/.env.local</code> (your GCP OAuth Web Client), then restart <code className="font-mono">npm run dev</code>.</p>
        </div>
      </div>
    );
  }
